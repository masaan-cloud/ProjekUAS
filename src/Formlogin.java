...
public void dataLogin(){   
        try{
            ...
            String sql = "SELECT * FROM tb_login WHERE username = '"+ user.getText() +"'";
    ...
    private void initComponents() {
        ...
        hak.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMIN", "BOS" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            rs = st.executeQuery("SELECT*from tb_login where username='"+ user.getText() +"' and password='"+ pass.getText() +"' and hak='"+ hak.getSelectedItem() +"'");

            if(rs.next()){
                if(rs.getString("hak").equals("ADMIN")){ 
                   Formutama fu = new Formutama();
                    fu.show();
                    this.dispose();
                    JOptionPane.showMessageDialog(rootPane, "Selamat Datang");
                }else if(rs.getString("hak").equals("BOS")){
